<?php include 'header.php';?>
			...
			<section id="single-page" class="section with-arrow">
				...
				<div class="section-header">
					<div class="container">
						<h1>Pembersihan Kali Ciliwung</h1>
					</div>
				</div>
				<!-- SECTION CONTENT -->
						...
						<div class="row">
							...
							<div class="col-md-9">
							    ...
							    <div class="event-date">
									...
									<p><span class="fa fa-money" aria-hidden="true"></span> 200rb/hari</p>
								</div>
					            ...
					            <div class="widget">
					              ...
					              <ul class="widget-latests list-unstyled">
					                <li>
					                  ...
					                  <span><span class="icon icon-location"></span> Depok</span>
									  <span><span class="fa fa-money" aria-hidden="true"></span> 100rb/hari</span></p>
									  </p>
